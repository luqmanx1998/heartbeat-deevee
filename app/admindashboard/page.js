...
export default function AdminDashboardPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-[#f3e7d3]">
      ...
      <div className="pointer-events-none absolute right-4 top-4 h-14 w-14 rounded-full bg-[radial-gradient(circle,rgba(120,172,255,0.65),rgba(120,172,255,0.16),transparent_70%)] blur-md" />
