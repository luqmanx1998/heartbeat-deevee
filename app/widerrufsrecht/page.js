...
export default function Page() {
  return (
    <LegalPage title="Widerrufsrecht">
      <h2>Widerrufsrecht für den Verkauf von Waren</h2>
      ...
      <ul>
        ...
        <li>
          ...
          mehreren Teilsendungen oder Stücken geliefert wird.
        </li>
      </ul>
      ...
      <p>
        Dies kann mittels einer eindeutigen Erklärung erfolgen, beispielsweise
      ...
      <p>
        Sie können Ihr Widerrufsrecht auch online unter einer entsprechend
        bezeichneten Schaltfläche auf unserer Webseite (www.deevee.io) ausüben.
      </p>
      ...
      <p>
        ...
        unverzüglich und spätestens binnen 14 Tagen zurückzuzahlen.
      </p>
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-white/75">
        <p>
          An Dana Jovanovic, Staigstraße 10, 89293 Kellmünz,
          E-Mail-Adresse: xdeeveee@gmail.com
        </p>
