...
export async function POST(request) {
  try {
    ...
    function formatNewsletterMessage(value) {
      return escapeHtml(value)
        .replace(
          /\[([^\]]+)\]\((https?:\/\/[^\s)]+)\)/g,
          '<a href="$2" style="color:#b8924f; text-decoration:underline;">$1</a>',
        )
    ...
    const safeMessage = formatNewsletterMessage(cleanMessage);
  ...
  <tr>
    <td align="center" bgcolor="#090909" style="background-color:#090909;">
      <img
        ...
        alt="Deevee"
        width="1200"
        style="width:1200px; max-width:100%; height:auto; display:block; border:0; outline:none; text-decoration:none;"
      />
    </td>
  </tr>
</table>
